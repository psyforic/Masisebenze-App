...
export class DocumentCreator {
    ...
    generateDoc(data, today) {
        ...
        this.getDoc(clientData, address, filteredDocuments, medicalData, workData, city,
            fullDate, currentAge, idNumber, today, assessmentReport, romReport);
    ...
    async getDoc(clientData, address, filteredDocuments, medicalData, workData, city,
        fullDate, currentAge, idNumber, today, assessmentReport, romReport) {
        const response = '../../../assets/doc/template.docx';
        ...
        saveAs(doc, clientData.firstName + '_' + clientData.lastName + '_' + 'Report.docx');
    }
}
